...
Una vez dividido todo el proyecto en módulos, podemos obtener el siguiente diagrama de Gantt~\ref{fig:diag_gantt}:

\begin{figure}[h]
  \begin{center}
    \includegraphics[angle=90,scale=0.65]{diagrama_gantt.png}
  \end{center}
