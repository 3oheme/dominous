...
% TODO FIXME: esto se puede aligerar con una tabla (o lista) de actividades con fechas de inicio y duración (o fecha fin)
...
\begin{figure}[h]
  \label{gantt}
  \begin{center}
    \includegraphics[angle=90,scale=0.9]{diagrama_gantt.png}
  \end{center}
