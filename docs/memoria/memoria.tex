...
% Los \addtocontents{lol}{\protect\addvspace{10pt}}
% Son para que los listados de cada capítulo
% Se separen de los del anterior en el índice de lstlisting
...
\chapter{Análisis}
\addtocontents{lol}{\protect\addvspace{10pt}}
\input{cap4_analisis.tex}

\chapter{Diseño}
\addtocontents{lol}{\protect\addvspace{10pt}}
\input{cap5_diseno.tex}

\chapter{Implementación}
\addtocontents{lol}{\protect\addvspace{10pt}}
\input{cap6_implementacion.tex}
