...
A la hora de afrontar un proyecto que simule cierto comportamiento \emph{humano}, debemos usar técnicas de Inteligencia Artificial, en busca de herramientas, técnicas y metodologías que nos ayuden a afrontar este difícil problema, probablemente uno de los más complicados dentro de la Ingeniería Informática. 
...
\begin{description}
    \item[Base de conocimiento] Contiene conocimiento modelado extraído del experto.
    ...
    \item[Interfaz de usuario] permite la interacción del usuario con
...
por regla. Sin embargo, como veremos, es suficiente para problemas
