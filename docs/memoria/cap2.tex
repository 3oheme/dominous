...
\begin{figure}[h]
  \label{cierre}
  \begin{center}
    \includegraphics[scale=0.3]{cierre.png}
  \end{center}
...
Hemos re resaltar y aclarar que, como bien dicta la frase de que \emph{el dominó es un juego de señores},
...
El juego por parejas, a diferencia de otros tipos de 
