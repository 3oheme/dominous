...
% TODO FIXME: Uniformizar puntos finales
...
Y en la siguiente imagen ~\ref{diagrama_clases_asociado} podemos observar el diagrama de clase asociado a los
requisitos obtenidos. \\

\begin{figure}[h]
  \label{diagrama_clases_asociado}
  \begin{center}
...
% TODO FIXME: falta el del desarrollo de una partida: iniciar, jugar cada turno (poniendo ficha o pasando) hasta que se acabe
